...
class First_1 extends StatefulWidget {
  First_1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _First_1State createState() => _First_1State();
}

class _First_1State extends State<First_1> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text('''The potato's fiber, potassium, vitamin C, and vitamin B6 content, coupled with its lack of cholesterol, all support heart health. Potatoes contain significant amounts of fiber.''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
