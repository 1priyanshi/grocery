                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Butter", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''It's a good source of vitamin A, a fat-soluble vitamin needed for skin health, immune function, and healthy vision ''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
