...
import 'package:grocery_1/second.dart';
import 'package:grocery_1/first.dart';
import 'package:grocery_1/third.dart';
import 'package:grocery_1/fourth.dart';
import 'package:grocery_1/five.dart';
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    onTap: (){
                        ...
                        child: _buildFruitCard("Kiwi", "images/kiwi.png","₹90", 0xffF7DFB9, 0XffFAF0DA),
                          ),
          ...
          onTap: (){
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => Third()));
                        ...
                        child: _buildFruitCard("Mango", "images/mango.png","₹150", 0xffF6E475, 0XffF9EFB0),
        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        child:_buildFruitCard("Papaya", "images/papaya.png","₹45", 0xffFFC498, 0XffFDDCC1),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                        ...
                        child:_buildFruitCard("Strawberry", "images/strawberry.png","₹200", 0xffF0AEAF, 0XffF8C6CA),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
