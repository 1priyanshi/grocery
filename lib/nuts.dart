...
import 'package:grocery_1/second_3.dart';
import 'package:grocery_1/first_2.dart';
import 'package:grocery_1/third_3.dart';
import 'package:grocery_1/fourth_3.dart';
import 'package:grocery_1/five_3.dart';
          ...
          children: <Widget>[
            Padding(
              ...
              context, MaterialPageRoute(builder: (context) => First_2()));
                      ...
                      child:  _buildFruitCard("Walnuts", "images/walnut.png","₹250", 0xffF7DFB9, 0XffFAF0DA),
              ),
          ...
          onTap: (){
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => Third_3()));
                       ...
                       child: _buildFruitCard("Pista", "images/pista.png","₹250", 0xffF6E475, 0XffF9EFB0),
        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                       ...
                       child: _buildFruitCard("Pumpkin Seeds", "images/pumpkinseeds.png","₹200", 0xffFFC498, 0XffFDDCC1),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                       ...
                       child: _buildFruitCard("Cashews", "images/cashew.png","₹349", 0xffF0AEAF, 0XffF8C6CA),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
