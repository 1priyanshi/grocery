...
class Fourth_2 extends StatefulWidget {
  Fourth_2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Fourth_2State createState() => _Fourth_2State();
}

class _Fourth_2State extends State<Fourth_2> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Pumpkin", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text("1pc(3kg - 8kg)", style: TextStyle(
                            color: Colors.orange,
                            fontWeight: FontWeight.bold,
                      ...
                      Padding(
                        ...
                        child: Text(''' Its nutrients and antioxidants may boost your immune system, protect your eyesight, lower your risk of certain cancers and promote heart and skin health. ''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
