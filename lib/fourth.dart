                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text("1 pc (1kg - 1.5kg)", style: TextStyle(
                            color: Colors.orange,
                            fontWeight: FontWeight.bold,
                      ...
                      Padding(
                        ...
                        child: Text('''Lower cholesterol. Papaya is rich in fibre, Vitamin C and antioxidants which prevent cholesterol build up in your arteries. ''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
