...
class Third_2 extends StatefulWidget {
  Third_2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Third_2State createState() => _Third_2State();
}

class _Third_2State extends State<Third_2> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Cucumber", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''It's high in beneficial nutrients, as well as certain plant compounds and antioxidants that may help treat and even prevent some conditions. ''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
