...
class Second_1 extends StatefulWidget {
  Second_1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Second_1State createState() => _Second_1State();
}

class _Second_1State extends State<Second_1> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Broccoli", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''Broccoli is a nutritional powerhouse full of vitamins, minerals, fiber and antioxidants. Broccoli contains various bioactive compounds that have been shown to reduceinflammation in your body’s tissues.''',
                          style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
