...
class Five_2 extends StatefulWidget {
  Five_2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Five_2State createState() => _Five_2State();
}

class _Five_2State extends State<Five_2> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text('''Carrots are a particularly good source of beta carotene, fiber, vitamin K1, potassium, and antioxidants. ''',
                          style: TextStyle(
                              color: Colors.black,
                              letterSpacing: 0.2,
                              fontWeight: FontWeight.bold,
